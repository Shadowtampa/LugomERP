...
return [
    ...
    */
    ...
    'remote_sites_path' => env('IGNITION_REMOTE_SITES_PATH', '/var/www'),
    'local_sites_path' => env('IGNITION_LOCAL_SITES_PATH', '/wsl.localhost/Ubuntu-22.04/home/luisgomes/dev/tcc/LugomERP'),
